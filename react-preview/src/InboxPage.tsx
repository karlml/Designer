/**
 * Inbox Page - Full Page View (Home)
 * A comprehensive messaging hub showing appointments, coach messages, 
 * health notifications, and system alerts with a personalized greeting,
 * health insights, and quick stats.
 */
...
// ============================================
// ORIGINAL INBOX HEADER - now simplified
// ============================================
...
export function InboxPage({ hideTabBar = false, onNavigate }: InboxPageProps) {
